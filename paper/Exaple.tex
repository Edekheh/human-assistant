...
\subsection{Simulation environment and used components} 
To perform integration and tests, Gazebo and Robot Operating System were choosen. Clearpath Dingo was used as a mobile platform and Panda Franka Emika was used as a manipulator. To perform localisation and mapping, Sick 2D LMS1xx lidar and Intel Realsense RGBD camera were used.pp[]. To allow robot to see objects from manipulator perspective, one Realsense camera was placed close to the efector ending. 
